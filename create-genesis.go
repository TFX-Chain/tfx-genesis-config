...
type consensusParams struct {
	...
	MaxSystemRewards         *math.HexOrDecimal256 `json:"maxSystemRewards"`
}
...
func createGenesisConfig(config genesisConfig, targetFile string) error {
	...
	invokeConstructorOrPanic(genesis, chainConfigAddress, chainConfigRawArtifact, []string{"uint32", "uint32", "uint32", "uint32", "uint32", "uint32", "uint256", "uint256", "uint256"}, []interface{}{
		...
		(*big.Int)(config.ConsensusParams.MaxSystemRewards),
	}, silent, nil)
...
var localNetConfig = genesisConfig{
	...
	ConsensusParams: consensusParams{
		...
		MaxSystemRewards:         (*math.HexOrDecimal256)(hexutil.MustDecodeBig("0xde0b6b3a7640000")), // 1 ether
	},
...
var devNetConfig = genesisConfig{
	...
	ConsensusParams: consensusParams{
		...
		MaxSystemRewards:        (*math.HexOrDecimal256)(hexutil.MustDecodeBig("0xde0b6b3a7640000")), // minimum staking amount for delegators (in ether)
	},
	InitialStakes: map[common.Address]string{

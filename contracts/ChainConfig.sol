...
contract ChainConfig is InjectorContextHolder, IChainConfig {
    ...
    event MaxSystemRewardsChanged(uint256 prevValue, uint256 newValue);
    ...
    function ctor(
        ...
        _consensusParams.maxSystemRewards = maxSystemRewards;
        emit MaxSystemRewardsChanged(0, maxSystemRewards);
    }
    ...
    function setMinStakingAmount(uint256 newValue) external override onlyFromGovernance {
        ...
        function getMaxSystemRewards() external view returns (uint256) {
        return _consensusParams.maxSystemRewards;
    }

    function setMaxSystemRewards(uint256 newValue) external  onlyFromGovernance {
        uint256 prevValue = _consensusParams.maxSystemRewards;
        _consensusParams.maxSystemRewards = newValue;
        emit MaxSystemRewardsChanged(prevValue, newValue);
    }
}